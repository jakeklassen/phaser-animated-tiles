...
export interface ExternalTiledTileset {
  firstgid: number;
  source: string;
}
...
export interface TiledLayerObjectgroup
  extends TiledLayerAbstract<"objectgroup"> {
  type: "objectgroup";
...
export type TiledLayer =
  ...
  | TiledLayerImagelayer
  | TiledLayerGroup;

// --MAP--

export type TiledMapType =
  | "orthogonal"
  | "isometric"
  | "staggered"
  | "hexagonal";
...
export interface TiledMapAbstract<O extends TiledMapType> {
  ...
  layers: TiledLayer[];
  tilesets:
    | ExternalTiledTileset[]
    | TiledTileset[]
    | Merge<ExternalTiledTileset, TiledTileset>[];
...
export interface TiledMapHexagonal
  extends TiledMapAbstract<"hexagonal">,
    TiledMapHexAndStag {
  orientation: "hexagonal";
  hexsidelength: number;
}

export interface TiledMapStaggered
  extends TiledMapAbstract<"staggered">,
    TiledMapHexAndStag {
...
export interface TiledPropertyAbstract<
  V extends TiledPropertyValue,
  T extends TiledPropertyType,
> {
  name: string;
  value: V;
  type: T;
